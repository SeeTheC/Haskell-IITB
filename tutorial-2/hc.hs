...
g4 = [(1,2),(2,3),(3,4),(4,1),(4,1),(1,4),(3,2),(4,3)]::Graph
g5 = [(1,2),(2,3),(3,4)]::Graph
g6 = [(1,2),(1,3)]::Graph
g7 = [(1,2),(2,3),(3,4),(4,1),(1,4),(3,2),(4,3),(5,6),(6,7),(7,8),(8,5),(1,5),(6,2),(3,7),(8,4),(5,1),(2,6),(7,3),(4,8)]::Graph
...
hc g  = [ x | x<- allPath, is_hc x g ]
        where allPath= concat [ makepath n g | n<-[(head.getAllVertices) g] ]
